	...
	<table>
		...
		<?php
			...
			<tr>
				...
				<td><a href="../delete.php?tabela=projetopoliticopedagogico&pk=<?php echo $row['obrigatoria'];?>,<?php echo $row['optativa'];?>,<?php echo $row['eletiva'];?>,<?php echo $row['conselhocurso_id'];?>">X</a></td>
			</tr>
			<?php
			}
		?>
